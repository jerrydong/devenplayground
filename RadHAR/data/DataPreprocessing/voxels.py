...
def get_data(file_path, data_type='mmwave'):
    """
    ...
    """
    if data_type == 'uwb':
        from .uwb_adapter import preprocess_uwb_data
        return preprocess_uwb_data(file_path)
    ...
    frame_num = frame_num.astype(np.int64)
